...
* **Styling:** StyleSheet (React Native), Custom Font (`Jameel Noori Nastaleeq Kasheeda.ttf` for Urdu).
...
3.  **Urdu Localization:** The app uses bilingual labels (English / Urdu). E.g., `Length / لمبائی`. Always apply the `Jameel Noori Nastaleeq Kasheeda` font family to Urdu text elements.
...
* **Backgrounds:** Pure White (`#FFFFFF`) or off-white (`#f9f9f9`) for input containers.
* **Text & Borders:** Dark Slate (`#161d26`).
* **Primary Accents & Active States:** Vibrant Mint Green (`#00e482`).
